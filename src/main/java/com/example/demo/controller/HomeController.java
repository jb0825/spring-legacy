...
public class HomeController {
    ...
    @PostMapping("/user")
    public String postDBFile(MultipartFile file, HttpSession session, RedirectAttributes redirect) {
        try {
            ...
            redirect.addFlashAttribute("message", "파일 업로드에 실패했습니다.");
        } catch (Exception e) {
            redirect.addFlashAttribute("message", "dbfile 만 업로드 할 수 있습니다");
        }
